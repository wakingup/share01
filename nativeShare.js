...
var nativeShare = function (elementNode, config) {
    ...
    this.other = function() {
        var position = document.getElementById(this.elementNode);
        var html = '<div class="shareWeixin" style="display: block;">' +
                   '<div class="icon-lianjieWeixin">' +
                   '<img src="/webPhone/img/shareIcon.png" alt="">' +
                   '<div class="shareIcontips">请使用浏览器的分享功能分享</div>' +
                   '<div class="shareWeixinBtn"><button class="btn btn-default" id="shareWeixinBtn">知道了</button></div>' +
                   '</div>' +
                   '</div>';
        position.innerHTML = html;
    };
